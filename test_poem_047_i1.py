...
class TestComponentIOIndependanceFromProb(unittest.TestCase):

    class Parabola(om.ExplicitComponent):

        def __init__(self):
            super(TestComponentIOIndependanceFromProb.Parabola, self).__init__()
            self.x = 0
            self.y = 999
            self.a = 999
    ...
    class ParabolaSystem(om.Group):
        ...
        def __init__(self):
            super(TestComponentIOIndependanceFromProb.ParabolaSystem, 
                self).__init__()
            self.p = TestComponentIOIndependanceFromProb.Parabola()
            self.x0 = 3
            self.y2 = 999
    ...
    def test_parabola(self):
        ...
        p = TestComponentIOIndependanceFromProb.Parabola()
        p.set_x(3)
        p.u_run_opt()
    ...
    def test_parabola_system(self):
        ...
        ps = TestComponentIOIndependanceFromProb.ParabolaSystem()
        ps.set_x0(3)
        ps.u_run_opt()
