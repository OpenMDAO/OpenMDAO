...
optional_dependencies = {
    "docs": ["matplotlib", "numpydoc>=1.1", "jupyter-book==0.14", "sphinx-sitemap", "ipyparallel"],
}
...
setup(
    ...
    package_data={
        ...
        "openmdao.visualization": ["common/libs/*.js", "common/style/*.css"],
        "openmdao.visualization.n2_viewer": [
            "assets/*png*",
            "libs/*.js",
            "src/*.js",
        ...
        "openmdao.devtools.iprofile_app": ["static/*.html", "templates/*.html"],
        "openmdao.docs": [
            "*.py",
            "openmdao_book/test/*.py",
            "openmdao_book/other/*.py",
            "openmdao_book/*.md",
            "openmdao_book/*/*.md",
            "openmdao_book/*.ipynb",
            "openmdao_book/*/*.ipynb",
        ...
        "openmdao.test_suite": ["*.py", "*/*.py", "matrices/*.npz"],
        "openmdao": ["*/tests/*.py", "*/*/tests/*.py", "*/*/*/tests/*.py"],
    },
    python_requires=">=3.7",
    install_requires=["networkx>=2.0", "numpy", "scipy", "requests", "packaging"],
    entry_points={
        "console_scripts": [
        ...
        "openmdao_lin_solver": [
            ...
            "linearschur=openmdao.solvers.linear.linear_schur:LinearSchur",
