...
- In the Custom report example, make sure the entry point doesn't collide with our default names. [#3092](https://github.com/OpenMDAO/OpenMDAO/pull/3092)
- Fix an error in the coefficient calculation for 2D slinear interp. [#3094](https://github.com/OpenMDAO/OpenMDAO/pull/3094)
...
- remove extraneous code; update CI to use conda-forge only [#3101](https://github.com/OpenMDAO/OpenMDAO/pull/3101)
