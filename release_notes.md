...
allow useres to compose more complex component compute methods without breaking them up for the sake
...
If components are functions of the design variables of the optimization, they are grouped into the "opt" set which is evaluated during each iteration of the necessary.
...
- Implemented POEM_077: Derivative checks with multiople step sizes. [#2927](https://github.com/OpenMDAO/OpenMDAO/pull/2927)
...
- Added path argument to N2 function [#2918](https://github.com/OpenMDAO/OpenMDAO/pull/2918)
...
- View connections fix [#2940](https://github.com/OpenMDAO/OpenMDAO/pull/2940)
...
- Fixed for hang in check_totals under MPI [#2888](https://github.com/OpenMDAO/OpenMDAO/pull/2888)
...
- Clean up internal handling of response names/aliases/source_names. [#2917](https://github.com/OpenMDAO/OpenMDAO/pull/2917)
