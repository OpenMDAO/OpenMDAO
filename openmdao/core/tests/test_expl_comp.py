...
class ExplCompTestCase(unittest.TestCase):
    ...
    def test_compute_and_list(self):
        ...
        with assert_warning(UserWarning, "'comp2' <class RectangleJacVec>: matrix free component has declared the following partials: [('comp2.area', 'comp2.area'), ('comp2.area', 'comp2.length'), ('comp2.area', 'comp2.width')], which will allocate (possibly unnecessary) memory for each of those sub-jacobians."):
            prob.run_model()
