...
class TestUnitConversion(unittest.TestCase):
    ...
    def test_incompatible_units(self):
        ...
        msg = "Group (<top>): Output 'src.x2' with units of 'degC' is connected to input 'tgt.xx' which has no units."
    ...
    def test_incompatible_connections(self):
        ...
        expected_msg = "Group (<top>): Output units of 'degC' for 'src.x2' are incompatible with input units of 'm' for 'dest.x2'."
