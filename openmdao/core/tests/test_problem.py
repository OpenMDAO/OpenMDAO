...
from openmdao.api import Problem, Group, IndepVarComp, PETScVector, NonlinearBlockGS, ScipyOptimizer, \
     ExecComp, Group, NewtonSolver, ImplicitComponent, ScipyGMRES
...
class TestProblem(unittest.TestCase):
    ...
    def test_system_setup_and_configure(self):
        ...
        class Super(Group):
            ...
            def configure(self):
                ...
                self.sub.linear_solver = ScipyGMRES()
        ...
        self.assertTrue(isinstance(top.model.sub.linear_solver, ScipyGMRES))
    ...
    def test_post_setup_solver_configure(self):
        ...
        top.model.sub.linear_solver = ScipyGMRES()

        self.assertTrue(isinstance(top.model.sub.nonlinear_solver, NewtonSolver))
        self.assertTrue(isinstance(top.model.sub.linear_solver, ScipyGMRES))

    def test_feature_system_configure(self):
        from openmdao.api import Problem, Group, ImplicitComponent, NewtonSolver, ScipyGMRES, NonlinearBlockGS
        ...
        print(isinstance(top.model.sub.linear_solver, ScipyGMRES))
