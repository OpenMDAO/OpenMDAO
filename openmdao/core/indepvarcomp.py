    ...
    **kwargs : dict
    ...
    def __init__(self, name=None, val=1.0, **kwargs):
        ...
        if 'tags' not in kwargs:
            kwargs['tags'] = {'indep_var', 'allow_desvar'}
        else:
            kwargs['tags'] = make_set(kwargs['tags'], name='tags') | {'indep_var', 'allow_desvar'}
    ...
    def add_output(self, name, val=1.0, shape=None, units=None, res_units=None, desc='',
        ...
        if tags is None:
            tags = {'indep_var', 'allow_desvar'}
        else:
            tags = make_set(tags) | {'indep_var', 'allow_desvar'}
