...
class TestSolverFeatures(unittest.TestCase):
    ...
    def test_specify_solver(self):
        from openmdao.api import Problem, NewtonSolver, ScipyGMRES, DirectSolver
        from openmdao.test_suite.components.sellar import SellarDerivatives
        ...
        newton.linear_solver = ScipyGMRES()
    ...
    def test_specify_subgroup_solvers(self):
        from openmdao.api import Problem, NewtonSolver, ScipyGMRES, DirectSolver, NonlinearBlockGS, LinearBlockGS
        from openmdao.test_suite.components.double_sellar import DoubleSellar
