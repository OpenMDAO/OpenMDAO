...
from openmdao.api import Problem, NewtonSolver, ScipyGMRES, Group, PETScVector, \
...
class TestSolverPrint(unittest.TestCase):
    ...
    def test_feature_iprint_neg1(self):
        from openmdao.api import Problem, NewtonSolver, ScipyGMRES
        from openmdao.test_suite.components.sellar import SellarDerivatives
        ...
        scipy = prob.model.linear_solver = ScipyGMRES()
    ...
    def test_feature_set_solver_print1(self):
        ...
        from openmdao.api import Problem, Group, IndepVarComp, NewtonSolver, ScipyGMRES, LinearBlockGS
        from openmdao.test_suite.components.double_sellar import SubSellar
