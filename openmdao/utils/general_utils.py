...
def get_post_setup_func(func_spec):
    """
    ...
    ----------
    func_spec : str
        Specifier for the function to be called by the hook.
        The form is: module_path:func_name.

    Returns
    -------
    function
        The function that sets the post setup hook and execs the file provided on the
        command line.
    """
    def func():
        import os
