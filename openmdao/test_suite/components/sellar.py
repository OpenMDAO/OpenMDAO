...
class SellarNoDerivatives(Group):
    ...
    def initialize(self):
        self.metadata.declare('nonlinear_solver', default=NonlinearBlockGS(),
        ...
        self.metadata.declare('linear_solver', default=ScipyGMRES(),
                              desc='Linear solver')
...
class SellarDerivativesGrouped(Group):
    ...
    def configure(self):
        self.mda.linear_solver = ScipyGMRES()
...
class SellarStateConnection(Group):
    ...
    def configure(self):
        ...
        self.sub.state_eq_group.linear_solver = ScipyGMRES()
