...
if __name__ == "__main__":
    from openmdao.api import Problem, Group, ScipyOptimizerDriver, ExecComp, IndepVarComp
    ...
    prob = Problem(model)
    prob.driver = ScipyOptimizerDriver()  # so 'openmdao cite' will report it for cite docs
    prob.setup()
    prob.run_model()
