""" Definition of the Paraboloid component with units, which evaluates the equation
(x-3)^2 + xy + (y+4)^2 = 3
"""
import openmdao.api as om


class ParaboloidWithUnits(om.ExplicitComponent):
    """
    ...
    def setup(self):
        ...
        self.add_output('f_xy', val=0.0, units='m')
