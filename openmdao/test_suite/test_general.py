...
class CompTestCaseBase(unittest.TestCase):
    ...
    def test_openmdao(self, component_class, vector_class, connection_type, global_jac, jacobian_type,
        ...
        prob.root._vectors['residual']['nonlinear'].add_scal_vec(-val, work)
