...
def find_object(start, pred, first_only=True):
    """
    Search through obj and all sub-object dicts for objects where pred returns True.
    ...
    start : object
        Starting object
    pred : function
        Returns True for desired objects.
    first_only : bool
        If True, stop looking after the first qualifying object is found.

    Returns
    -------
    list
        List of names and values satisfying pred.
    """
    stack = [('<unknown>', start)]
    found = []
    seen = set([id(start)])
    ...
    while stack:
        ...
        try:
            ...
            # TODO: figure out how slots work
            continue
