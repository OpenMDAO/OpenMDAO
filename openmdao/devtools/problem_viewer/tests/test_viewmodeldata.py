...
class TestViewModelData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.expected_tree = json.loads('{"name": "root", "type": "root", "subsystem_type": "group", "linear_solver": "LN: SCIPY", "nonlinear_solver": "NL: Newton", "is_parallel": false, "children": [{"name": "px", "type": "subsystem", "subsystem_type": "component", "linear_solver": "", "nonlinear_solver": "", "is_parallel": false, "children": [{"name": "x", "type": "unknown", "implicit": false, "dtype": "ndarray"}]}, {"name": "pz", "type": "subsystem", "subsystem_type": "component", "linear_solver": "", "nonlinear_solver": "", "is_parallel": false, "children": [{"name": "z", "type": "unknown", "implicit": false, "dtype": "ndarray"}]}, {"name": "sub", "type": "subsystem", "subsystem_type": "group", "linear_solver": "LN: SCIPY", "nonlinear_solver": "NL: RUNONCE", "is_parallel": false, "children": [{"name": "state_eq_group", "type": "subsystem", "subsystem_type": "group", "linear_solver": "LN: SCIPY", "nonlinear_solver": "NL: RUNONCE", "is_parallel": false, "children": [{"name": "state_eq", "type": "subsystem", "subsystem_type": "component", "linear_solver": "", "nonlinear_solver": "", "is_parallel": false, "children": [{"name": "y2_actual", "type": "param", "dtype": "ndarray"}, {"name": "y2_command", "type": "unknown", "implicit": true, "dtype": "ndarray"}]}]}, {"name": "d1", "type": "subsystem", "subsystem_type": "component", "linear_solver": "", "nonlinear_solver": "", "is_parallel": false, "children": [{"name": "z", "type": "param", "dtype": "ndarray"}, {"name": "x", "type": "param", "dtype": "ndarray"}, {"name": "y2", "type": "param", "dtype": "ndarray"}, {"name": "y1", "type": "unknown", "implicit": false, "dtype": "ndarray"}]}, {"name": "d2", "type": "subsystem", "subsystem_type": "component", "linear_solver": "", "nonlinear_solver": "", "is_parallel": false, "children": [{"name": "z", "type": "param", "dtype": "ndarray"}, {"name": "y1", "type": "param", "dtype": "ndarray"}, {"name": "y2", "type": "unknown", "implicit": false, "dtype": "ndarray"}]}]}, {"name": "obj_cmp", "type": "subsystem", "subsystem_type": "component", "linear_solver": "", "nonlinear_solver": "", "is_parallel": false, "children": [{"name": "x", "type": "param", "dtype": "ndarray"}, {"name": "y1", "type": "param", "dtype": "ndarray"}, {"name": "y2", "type": "param", "dtype": "ndarray"}, {"name": "z", "type": "param", "dtype": "ndarray"}, {"name": "obj", "type": "unknown", "implicit": false, "dtype": "ndarray"}]}, {"name": "con_cmp1", "type": "subsystem", "subsystem_type": "component", "linear_solver": "", "nonlinear_solver": "", "is_parallel": false, "children": [{"name": "y1", "type": "param", "dtype": "ndarray"}, {"name": "con1", "type": "unknown", "implicit": false, "dtype": "ndarray"}]}, {"name": "con_cmp2", "type": "subsystem", "subsystem_type": "component", "linear_solver": "", "nonlinear_solver": "", "is_parallel": false, "children": [{"name": "y2", "type": "param", "dtype": "ndarray"}, {"name": "con2", "type": "unknown", "implicit": false, "dtype": "ndarray"}]}]}')
