...
"""
    ...
    for listing in os.listdir(os.path.join(docs_dir, "experimental_source")):
        if os.path.isdir(os.path.join("experimental_source", listing)):
    ...
    for package in packages:
        ...
        for sub_listing in sorted(os.listdir(os.path.join("experimental_source", package.replace('.','/')))):
