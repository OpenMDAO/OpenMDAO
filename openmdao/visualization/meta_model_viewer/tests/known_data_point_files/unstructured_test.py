...
# Training Data
x_train1 = np.genfromtxt('unstructured_data_points.csv', delimiter=',', usecols=(0))
x_train2 = np.genfromtxt('unstructured_data_points.csv', delimiter=',', usecols=(1))
x_train3 = np.genfromtxt('unstructured_data_points.csv', delimiter=',', usecols=(2))
