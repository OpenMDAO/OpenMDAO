...
the system. When to choose this solver over :ref:`NonlinearBlockGS <usr_openmdao.solvers.nonlinear_bgs.py>`
...
.. embed-test::
    openmdao.solvers.tests.test_nonlinear_bjac.TestNLBlockJacobi.test_feature_basic
...
- maxiter
  ...
  .. embed-test::
      openmdao.solvers.tests.test_nonlinear_bjac.TestNLBlockJacobi.test_feature_maxiter
...
- atol
  ...
  .. embed-test::
      openmdao.solvers.tests.test_nonlinear_bjac.TestNLBlockJacobi.test_feature_atol
...
- rtol
  ...
  .. embed-test::
      openmdao.solvers.tests.test_nonlinear_bjac.TestNLBlockJacobi.test_feature_rtol
