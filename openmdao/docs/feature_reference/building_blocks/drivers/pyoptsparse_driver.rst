...
.. note::
    The pyOptSparse package does not come included with the OpenMDAO installation. It is a serparate optional package that can be obtained
    from  mdolab_.
...
SNOPT has a large number of customizable settings. Here we only show a couple of common ones.
...
.. _mdolab: https://bitbucket.org/mdolab/pyoptsparse
