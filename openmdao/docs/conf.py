...
from openmdao.docs._utils.automate import automate
...
# before we set the version that will be listed in the docs, run automate,
# which will check to see if the docs header should display git commit or release version
# this function sets env var 'OPENMDAO_DOCS_VERSION'
automate()
...
# This env var is set in _utils/automate.py, will override above release val.
if 'OPENMDAO_DOCS_VERSION' in os.environ:
    release = os.environ['OPENMDAO_DOCS_VERSION']
